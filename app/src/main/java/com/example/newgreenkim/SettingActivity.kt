...
import com.example.greenkim.BadgeActivity
import com.example.greenkim.BadgeAdapter
import com.example.greenkim.BadgeList
...
class SettingActivity : AppCompatActivity() {
    ...
    private val pickMedia =
        registerForActivityResult(ActivityResultContracts.PickVisualMedia()) { uri ->
            if (uri != null) {
                Log.d("SettingActivity", "Selected URI: $uri")
                uploadedImages.add(uri)
            } else {
                Log.d("SettingActivity", "No media selected")
            }
        }
    ...
    private fun initUi() {
        ...
        findViewById<ImageView>(R.id.question_button).setOnClickListener {
            startActivity(Intent(this, BadgeActivity::class.java).apply {
                addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP or Intent.FLAG_ACTIVITY_CLEAR_TOP)
            })
        }

        //region Initialize badge list
        val badgeRecyclerView = findViewById<RecyclerView>(R.id.badge_recycler_view)
